...
function AppFeatures() {
  const features = [
    ...
    { icon: MousePointerClick, title: "Click-Through Mode", description: "Enable click-through to interact with underlying applications without interference.", src: 'https://cdn.jsdelivr.net/gh/raffay69/shadow-ai@152c13a/public/click-through.mov' },
    { icon: CircleHelp, title: "Debug Mode", description: "Enables iterative troubleshooting by allowing screenshot capture and analysis after applying a solution. If errors or unexpected behavior occur, the system can review visual output, identify issues, and refine the solution accordingly.", src: 'https://cdn.jsdelivr.net/gh/raffay69/shadow-ai@912c573/public/debug.mov' }
